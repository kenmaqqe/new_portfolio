...
export default function CodeAvatar() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-72 h-72 md:w-96 md:h-96 rounded-2xl bg-surface border border-border overflow-hidden flex flex-col"
    >
      ...
      <div className="flex-1 p-5 font-mono text-[11px] leading-[1.4] overflow-hidden">
        {codeLines.map((line, lineIdx) => (
          <div key={lineIdx} className="whitespace-pre h-[1.4rem]">
